...
export default function AiTwinChat({ className = '' }: { className?: string }) {
  ...
  return (
    <div className={`glass-panel-heavy rounded-[1.5rem] wide:rounded-[clamp(1.5rem,2vw,2.5rem)] p-4 wide:pt-[clamp(16px,1.5vw,40px)] wide:pb-[clamp(12px,1vw,32px)] wide:px-[clamp(16px,1.5vw,40px)] relative overflow-hidden h-[320px] wide:h-full wide:min-h-[clamp(320px,30vw,480px)] wide:max-h-[clamp(380px,35vw,560px)] flex flex-col w-[240px] sm:w-[280px] lg:w-full lg:max-w-[380px] wide:w-full wide:min-w-[clamp(280px,22vw,420px)] wide:max-w-[clamp(360px,28vw,520px)] ${className}`}>
      {/* Header */}
